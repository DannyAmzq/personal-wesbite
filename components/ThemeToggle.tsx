...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="relative inline-flex h-[28px] w-[52px] items-center rounded-full border border-[color-mix(in_oklab,var(--foreground)_16%,transparent)] bg-[color-mix(in_oklab,var(--background)_90%,transparent)] focus-visible:outline-none focus-visible:ring-2 ring-accent"
      role="switch"
      aria-checked={isDark}
    ...
    >
      <motion.span
        layout
        className="pointer-events-none absolute left-1 top-1 inline-flex h-[22px] w-[22px] items-center justify-center rounded-full bg-[var(--foreground)] text-[var(--background)] shadow"
